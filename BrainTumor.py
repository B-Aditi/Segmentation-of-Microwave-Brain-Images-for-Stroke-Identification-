...
main = tkinter.Tk()
main.title("Microwave Medical Image Segmentation Brain Stroke") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Microwave Medical Image Segmentation Brain Stroke')
